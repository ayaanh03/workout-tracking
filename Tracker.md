...
26. **T-pace re-test W6 Tue 5/26 (Adj #16 / #9):** 5×5 min @ T at 8:00/mi, cadence 180 spm, HR by rep 167 / 177 / 179 / 180 / 183 (peak 183). Run logged separate from PM Hyp A (still to log) → **standard ordering restored, Adj #16 re-test executed** (vs W5 Tue lift-first back-to-back). **Peak 183 is the lowest T-effort peak in the log** (W5 Tue 188, W4 Fri 181) despite 25 min work; controlled opener (167) confirms a proper WU. HR evidence supports **holding 8:00/mi as legit threshold** — don't slow to 8:05–8:10 — **but RPE was not reported, so the formal RPE-gate of Adj #16 is not closed; confirm subjective RPE ≤7 to lock the pace.** Peak 183 = 96% of rower max 191 on a threshold effort → continues to support true run MHR > 191 (Adj #9); formal MHR retest still owed W6–W8.
...
|2026-05-26|W6 Tue|Threshold run (T-pace re-test)|5×5 min @ T, 1 min jog rec (25 min work); WU/CD n/r|work 8:00/mi (slow end §4.A T band 7:55–8:10); cadence 180 spm|reps 167 / 177 / 179 / 180 / 183 (avg ~177, peak 183)|**Formal T-pace re-test under restored standard ordering (Adj #16)** — run logged separate from PM Hyp A (still pending), vs W5 Tue's lift-first back-to-back. Matches §4.C W6 Tue prescription (5×5 min @ T, 1 min rec) ✓. Pace 8:00/mi at slow end of T band ✓; cadence 180 spm = mid §2.B quality band (175–182) ✓ — consistent w/ W4 Fri / W5 Tue T-runs. **HR climb 167 → 183 across the 5 reps = normal across-rep cardiac drift; controlled opener (167) signals a proper WU** (vs W5 Tue's cold 127 → 180 ramp). **Peak 183 is the lowest T-effort peak in the log** (W5 Tue 188, W4 Fri 181) despite 25 min total work and standard ordering — the cleaner read Adj #16 was after; cooler HR on the same 8:00/mi supports the pace being legit threshold, not over-threshold. **RPE not reported** — the explicit RPE gate from Adj #16 ("8:00/mi should feel RPE ≤7") can't be formally closed without it; HR evidence leans toward holding 8:00/mi rather than slowing to 8:05–8:10, but mark provisional pending subjective input. **Peak 183 = 96% of rower max 191 on a threshold (~85–88%) effort** = implausibly high if 191 is true max → continues to support run MHR > 191 (Adj #9); formal MHR retest (treadmill 1% or 1500m all-out) still owed W6–W8. SI status not reported. Carry-forward → Adj #26.|
...
|W6|✓ Z1 + 4×20s strides 5-25 (cadence 180/178/196/180; Adj #24 mostly held, rep 4 textbook)|✓ T-run 5×5 @ 8:00 5-26 (re-test, peak 183; Hyp A PM pending)|—|—|—|—|in progress|