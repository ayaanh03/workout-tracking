...
|2026-05-18|W5 Mon|Z1 easy run + strides|3.22 mi / 30:08 (elapsed 31:37)|9:21/mi avg; range 14:45 → 7:08/mi (fast end = strides)|avg 179, peak 189, low 106|**Nasal breathing for the most part** = aerobic / sub-LT1 by physiological gate (nasal likely broke during strides — consistent with 7:08/mi tail of pace range). Cadence avg 165 spm (range 134–189). First W5 session = §4.C W5 Mon prescription (Z1 easy 30 min + 4×20 s strides) ✓. Avg pace 9:21/mi is faster than prior Z1 outings (W4 Sat 10:38/mi, W4 Tue 11:30/mi) — strides component pulls the average down; steady-state segment likely sat closer to 9:30–10:00/mi. Avg HR 179 / peak 189 runs hot vs prior easy runs (W4 Sat avg 167 / peak 172) — strides spike accounts for some, but steady-state HR also drifting up. Nasal gate held = still aerobic, but borderline. HR runs well above off-191 Z1 cap (≤155); per Adjustment #9 zones skew low for running until MHR retest. Outdoor; shoes presumed Vomero Plus (daily trainer). Peak 189 / 191 rower max = 99% — more evidence true run MHR > 191. Watch tomorrow AM for SI / soreness given strides component.|
...
|W5|✓ Z1 run + strides 5-18|—|—|—|—|—|in progress|