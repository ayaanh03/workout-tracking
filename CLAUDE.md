...
- `history/` — **everything historical for the tracker side, one append-only file per stream; live files hold the current phase, trimmed by the ~40 KB backstop:** `history/adjustments.md` (the numbered ledger, **Adj #309+** — #164–#253 rotated to `archive/adjustments-164-253.md` 2026-08-12, Adj #272; #254–#282 rotated to `archive/adjustments-254-282.md` 2026-08-19, Adj #295; #283–#308 rotated to `archive/adjustments-283-308.md` 2026-08-24, Adj #311), `history/lifting-log.md` (**W17+** — W13–W16 rotated to `archive/lifting-log-W13-W16.md`, same pass), `history/cardio-log.md` (Build W13+), `history/si-log.md`, `history/weekly-summary.md` (completed weeks), `history/incline-bb.md` (current meso, whole). Every live file's append point is **end of file**. Completed phases live verbatim in `history/archive/`. `Tracker.md` cites an Adj # or week; to resolve a cited Adj #N: `grep -rn '^N\. ' history/` — **never read a history file in full.**
